    ...
    '@graph': [
      {
        ...
        address: {
          ...
          addressLocality: doctor.commune || doctor.wilayas?.name_ar,
          addressRegion: doctor.wilayas?.name_ar,
          addressCountry: 'DZ',
        },
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-3">
                  ...
                  {doctor.reviews_count > 0 && (
                    <span className="text-xs text-gray-400 mr-1">· {doctor.reviews_count} تقييم</span>
                  )}
                </div>
                {doctor.count_views > 0 && (
                  <div className="flex items-center gap-1.5 mt-2 text-xs text-gray-400">
                    ...
                    <span>{doctor.count_views.toLocaleString('ar-DZ')} شخص زار هذا الملف</span>
                  </div>
                )}
              </div>
            </div>
