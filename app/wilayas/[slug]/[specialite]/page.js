...
export default async function WilayaSpecialitePage({ params, searchParams }) {
  ...
  const { data: specialty } = await supabase
    .from('specialties').select('*').eq('slug', specialite).single()
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {totalPages > 1 && (
          <div className="flex justify-center gap-2 mt-8 flex-wrap">
            {currentPage > 0 && (
              <a href={`/wilayas/${slug}/${specialite}?page=${currentPage - 1}`}
            ...
            {Array.from({ length: Math.min(totalPages, 7) }, (_, i) => {
              ...
              return (
                <a key={pageNum}
                  href={`/wilayas/${slug}/${specialite}?page=${pageNum}`}
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-gray-50 rounded-xl p-4">
              ...
              <p className="text-gray-500 text-sm">
                ...
                a {wilayaData.name_fr} sur Dalil Atibaa.
              </p>
            </div>
            <div className="bg-gray-50 rounded-xl p-4">
              <p className="font-medium text-gray-700 mb-1">
              ...
              <p className="text-gray-500 text-sm">
                Cliquez sur la fiche du medecin pour voir son numero
