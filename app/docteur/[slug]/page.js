        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="mt-5 flex gap-3 lg:hidden">
              <CallButton doctorId={doctor.id} phone={doctor.phone}
              ...
              {doctor.phone && (
                <WhatsappButton doctorId={doctor.id} whatsappNumber={whatsappNumber}
          ...
          {doctor.latitude && doctor.longitude && (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <MapButton doctorId={doctor.id} mapUrl={doctor.google_map_url || `https://maps.google.com/maps?q=${doctor.latitude},${doctor.longitude}`}
